...
if (talkedRecently.has(message.author.id)) {
 if(message.author.id === '504254802088427540'){  return message.channel.send( message.author + "Bu Komutu 1 Saatte Bir Kullanabilirsin! " );
    }} else {
...
let channel = bot.channels.get("752477251647307806")//bug repot kanal id
